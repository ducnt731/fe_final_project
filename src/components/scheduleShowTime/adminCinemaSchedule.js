...
import { fetchAllShowTimeByCinema, fetchAllShowTimeDaily } from "../../service/userService";
...
const AdminCinemaShowTimeSchedule = () => {
    ...
    const getAllShowTimeDaily = async () => {
        try {
            const response = await fetchAllShowTimeByCinema();
        ...
        <div className="account-container">
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "20px", marginLeft: "18px" }}>
                ...
                <div className="account-container" style={{ marginRight: "20px" }} >
                    ...
                    <a style={{ marginLeft: "10px" }} href="/admin-cinema/show-time" className="btn btn-primary">Back</a>
                </div>
            </div>
...
export default AdminCinemaShowTimeSchedule;
